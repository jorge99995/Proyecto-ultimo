    ...
    <div class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li class="submenu {{set_active(['home','teacher/dashboard','student/dashboard'])}}">
                    ...
                    <ul>
                        ...
                        {{-- <li><a href="{{ route ('teacher/dashboard') }}" class="{{set_active(['teacher/dashboard'])}}">Teacher Dashboard</a>
                </li> --}}
            ...
            <li class="submenu {{set_active(['list/users'])}} {{ (request()->is('view/user/edit/*')) ? 'active' : '' }}">
                ...
                <ul>
                    <li><a href="" class="{{set_active(['list/users'])}} {{ (request()->is('view/user/edit/*')) ? 'active' : '' }}">List Users</a></li>
                </ul>
            </li>
            @endif
            ...
            <li class="submenu {{set_active(['department/add/page','department/edit/page'])}}">
                ...
                <ul>
                    <li><a href="" class="{{set_active(['department/list/page'])}}">Department List</a></li>
                    <li><a href="" class="{{set_active(['department/add/page'])}}">Department Add</a></li>
                    <li><a href="" class="{{set_active(['department/edit/page'])}}">Department Edit</a></li>
                </ul>
            </li>
            <li class="submenu">
